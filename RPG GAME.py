...
#CLASSES
#class Enemy: #todo, like something so that u can easily create enimies. hopefully at random and not so that the game is broken (aka balance the enemy with the character's stats.)
